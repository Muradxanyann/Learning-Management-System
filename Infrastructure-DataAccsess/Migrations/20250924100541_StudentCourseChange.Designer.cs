...
namespace Infrastructure___Persistence.Migrations
{
    ...
    [Migration("20250924100541_StudentCourseChange")]
    partial class StudentCourseChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.StudentCourseEntity", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.StudentCourseEntity", b =>
                {
                    b.HasOne("Domain.CourseEntity", "Course")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_student_course_courses_course_id");
                    ...
                    b.HasOne("Domain.Entities.ApplicationUser", "Student")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_student_course_users_student_id");
